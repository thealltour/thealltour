...
const REPLACEMENTS = [
  ...
  ["@/components/ProductDetailSticky", "@/components/product-detail/ProductDetailSticky"],
  ["@/components/ProductDetailHero", "@/components/product-detail/ProductDetailHero"],
  ["@/components/ProductDetailTabsLegacy", "@/components/product-detail/ProductDetailTabsLegacy"],
  ["@/components/ProductDetailTabs", "@/components/product-detail/ProductDetailTabs"],
  ["@/components/ProductDetailContentLegacy", "@/components/product-detail/ProductDetailContentLegacy"],
