...
export default function ProductListCardMobile({
  ...
  const cardClassName = cn(
    "group w-full cursor-pointer overflow-hidden rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--surface)] shadow-[var(--shadow-soft)]",
    CARD_TRANSITION,
