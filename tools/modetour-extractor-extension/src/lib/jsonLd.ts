 ...
 * DOM보다 우선 사용할 수 있도록 Partial<ModetourImportV1> 형태로 반환.
 */
export function mapJsonLdToImport(productLd: JsonLdProduct | undefined): Partial<ModetourImportV1> | null {
  ...
  const result: Partial<ModetourImportV1> = {};
  if (name) {
