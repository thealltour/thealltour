 ...
 * buildImport.ts에서 HanatourImportV1으로 변환.
 */

import type { HanatourImageHeuristicHints } from "~types/hanatourImport";
...
export type ExtractMeta = {
  ...
  itineraryDomDebug?: {
    ...
    parserStrategy?: "timelineCard" | "hanatourCard" | "lineFallback" | "merged";
    parserStrategies?: Array<"timelineCard" | "hanatourCard" | "lineFallback" | "merged">;
    eventSourceCountsByDay?: Array<{
      timeline: number;
      section: number;
      location: number;
      sightseeing: number;
  ...
  imageDebug?: {
    ...
    /** 상품 상단 갤러리 수집 장수 (슬라이드 기준, max 10) */
    productGalleryCount?: number;
  };
