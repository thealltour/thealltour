...
export default function ModetourNewProductPage() {
  ...
  async function handleValidate() {
    ...
    try {
      ...
      if (res.ok) {
        const data = (await res.json()) as { payload: ModetourImportV1; stats: NormalizeImportImageStats };
    ...
    const extraWarnings = buildImageNormalizeExtraWarnings(normalizeStats) as ModetourImportWarning[];
