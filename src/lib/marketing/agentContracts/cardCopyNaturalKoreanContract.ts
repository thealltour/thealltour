...
export const CARD_COPY_NATURAL_KOREAN_CONTRACT_EN = [
  ...
  "Prefer naming what differs over stacking abstract nouns (frame / rhythm / context / reading metaphors).",
  "(Keep examples minimal — do not treat instructional contrasts as consumer lexical seeds.)",
  "",
  ...
  '  Weak direction: "전환되는 북부 국경이라는 추상 슬로건"',
  "",
  "BODY:",
  ...
  "",
  "CLOSING CARD:",
  "Concrete payoff is enough — no forced philosophical synthesis and no forced CTA.",
  "A concrete fact, contrast, or observation is a valid closing.",
