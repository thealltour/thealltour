  ...
  async function loadSettings(skipLoadingIndicator = false) {
    try {
      ...
      const nextSettings: SiteSettings = {
        ...
        home_golf_tour_product_ids: data.home_golf_tour_product_ids ?? "[]",
        home_golf_tour_section_eyebrow: data.home_golf_tour_section_eyebrow ?? "",
        home_golf_tour_section_title: data.home_golf_tour_section_title ?? "",
        home_golf_tour_section_description: data.home_golf_tour_section_description ?? "",
