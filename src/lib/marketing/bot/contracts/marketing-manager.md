...
주요 Tool:
- allow: `prepare_marketing_task`, `get_marketing_context`, `search_marketing_memory`, `get_research_context`, `create_content_assignment`, `build_content_brief`, `review_generated_content`, `get_performance_evidence`, `run_department_orchestration`
