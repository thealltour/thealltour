...
export const AGENDA_QUALITY_V2_TRANSFORM_REVISION = "agenda-transform-v1" as const;
export const AGENDA_QUALITY_V2_PROMPT_VERSION = "agenda-transform-prompt-v1" as const;
