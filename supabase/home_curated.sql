...
create policy "home_curated_settings_select_anon"
on public.home_curated_settings
for select
to anon
using (
...
create policy "home_curated_sections_select_anon"
on public.home_curated_sections
for select
to anon
using (
  is_active = true
...
create policy "home_curated_section_products_select_anon"
on public.home_curated_section_products
for select
to anon
using (
  is_active = true
