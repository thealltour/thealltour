...
| Local modifications | **Subset only**: TreeView + SpanCard closure. `DetailsView` / `TraceViewer` omitted (npm 0.0.9 lacks newer `RunErrorEntry`; also avoids In/Out/Raw surfaces). |
