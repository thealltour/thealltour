...
export const kakaoSyncGolfConfig = {
  ...
  benefit: {
    ...
    reassurance: {
      title: "안심 가입 보장",
      bullets: [
        "가입비·연회비 0원 (신용카드 정보 입력 없음)",
        "불필요한 영업 전화 0건 (알림톡으로 혜택만 전달)",
        "동반자 가입 없이 대표 1명 계정으로 전원 적용",
      ],
    },
  },
  ...
  faq: {
    ...
    items: [
      ...
      {
        question: "가입하면 광고·영업 전화가 오나요?",
        answer:
          "아니요. 불필요한 영업 전화·스팸 문자는 보내지 않으며, 혜택·예약 안내는 알림톡으로만 전달합니다.",
      },
      {
  ...
  cta: {
    label: "카카오로 1초 만에 5만원 쿠폰 받기",
    stickyTop: "부담스러운 영업 전화는 일절 드리지 않아요",
    stickyBottom: "대표 1명만 가입해도 동반자 전원 자동 할인",
  },
} as const;
