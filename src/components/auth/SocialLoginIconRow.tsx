...
function ProviderIcon({ providerId }: { providerId: AuthProviderId }) {
  if (providerId === "google") return <GoogleIcon className="h-5 w-5" />;
  if (providerId === "kakao") return <KakaoIcon className="h-[18px] w-[18px]" />;
  return <NaverIcon className="h-4 w-4" />;
}
