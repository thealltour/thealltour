...
export function formatAstraHandoffWriterPrompt(
  ...
  return [
    ...
    "Preserve SVP master subject differentiation — do not invent new subjects to fix upstream weakness.",
    "Do not collapse lived-environment / cultural_context intents back into generic mountain landscape.",
    "Enrich composition/atmosphere/text-safe/evidence constraints while keeping subject class intact.",
    "",
    "INPUT_JSON:",
