...
export function createInitialHumanReview(
  ...
  // Keep bootstrap free of Node fs / publishable composers — client bundles import
  // sanitize helpers from this module. Morning review context swaps publishable copy for display.
...
export {
  ...
  safeExternalUrl,
} from "@/lib/marketing/review/textDisplay";
