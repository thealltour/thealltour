...
const API_PATH_PERMISSIONS: Array<{ prefix: string; permission: AdminPermissionKey }> = [
  ...
  { prefix: "/api/admin/marketing-operations", permission: "settings.manage" },
  { prefix: "/api/admin/marketing-observability", permission: "settings.manage" },
  { prefix: "/api/admin/trend-intake", permission: "settings.manage" },
...
const CONSOLE_PATH_RULES: Array<{
  ...
  { test: (r) => r.startsWith("/ai-marketing") || r.startsWith("/ai-runtime") || r.startsWith("/marketing-review") || r.startsWith("/marketing-operations") || r.startsWith("/marketing-observability") || r.startsWith("/trend-inbox"), anyOf: ["settings.manage"] },
...
export const SIDEBAR_PERMISSION_MAP: Record<string, AdminPermissionKey[]> = {
  ...
  tools_ai_marketing: ["settings.manage"],
  tools_ai_runtime: ["settings.manage"],
  tools_marketing_review: ["settings.manage"],
  tools_marketing_operations: ["settings.manage"],
  tools_marketing_observability: ["settings.manage"],
  tools_trend_inbox: ["settings.manage"],
