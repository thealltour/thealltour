...
4) reader payoff (semantic outcome — need not be a final abstract sentence)
5) optional natural close (concrete observation / contrast / light question / none — all valid)
Preserve evidence limitations when omission would materially overstate the Story.
Do not force abstract synthesis about perspective, meaning, awareness, insight, or decision criteria.
...
BODY:
Short paragraphs; natural Korean; one thought per paragraph; concrete detail before promotion.
...
CLOSE (optional):
Discovery-valid: concrete observation or contrast on the SAME Story; light question; or no ending — no forced abstract editorial synthesis; no CTA.
