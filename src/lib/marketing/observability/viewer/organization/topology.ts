...
export const MARKETING_ORG_V21_NODES: MarketingOrganizationNodeDef[] = [
  ...
  {
    id: "channel_composers",
    label: "Channel Composers",
    kind: "deterministic",
    tier: "workflow",
    spanStages: ["publishable_compose", "channel_compose"],
    spanNames: ["marketing.publishable", "marketing.channel_composer"],
    description: "Channel-native publishable bodies + CTA from Proposition",
  },
  {
    id: "marketing_value_gate",
    label: "Marketing Value Gate",
    kind: "validation",
    tier: "workflow",
    spanStages: ["marketing_value"],
    spanNames: ["marketing.value"],
    description: "MQ-5 usefulness / specificity / CTA (≠ Governance)",
  },
  {
    id: "human_review",
    label: "Human Review",
...
export const MARKETING_ORG_V21_EDGES: MarketingOrganizationEdgeDef[] = [
  ...
  },
  {
    id: "ga_to_composers",
    source: "governance_auditor",
    target: "channel_composers",
    kind: "mandatory_handoff",
    label: "publishable compose",
  },
  {
    id: "composers_to_value",
    source: "channel_composers",
    target: "marketing_value_gate",
    kind: "mandatory_handoff",
    label: "value score",
  },
  {
    id: "value_to_human_review",
    source: "marketing_value_gate",
    target: "human_review",
    kind: "mandatory_handoff",
  },
  {
